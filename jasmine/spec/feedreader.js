...
$(function() {
    ...
    describe('The menu', function() {
         ...
         */
        it('menu dislays when click and hide when click again', function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('at least one single entry within feed container', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, done);
            spyEvent = jasmine.createSpy('DOMhasChanged');
